    ...
    <Kontanctme/>
            ...
            <footer className="bg-gradient-to-r from-gray-800 to-gray-900 fixed bottom-0 w-full h-2/3 ">
                ...
                <div className="flex justify-center items-center pt-4 pb-8 text-2xl">
                    <h1 className='text-gray-200 text-center leading-relaxed'>
                ...
                <ul className="flex justify-center space-x-4 mt-4">
                    <li>
                        <div className="p-2 rounded-full border border-[#d6ae57] hover:bg-[#d6ae57] transition duration-500 ease-in-out shadow-lg shadow-cyan-500/50">
